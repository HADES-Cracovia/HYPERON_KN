...
directory="../output_newGeometryM3_ver3_pi0_RICH2_check/" #oryginal data directory
#fname="../files_list_M3.dat" #file with list of expected files
#fname="file5758_list.dat"
fname="../files_list_newRICH2.dat"

import subprocess
print("Copy and hadd files from \"output_newGeometryM3_ver3_pi0_RICH_check\" directory")
import time
import os

...
directory="../output_new_geometry/" #oryginal data directory
fname="../files_list_5857.dat" #file with list of expected files
#fname="file5758_list.dat"

import subprocess
print("Copy and hadd files from \"output_new_geometry\" directory")
import time
import os
